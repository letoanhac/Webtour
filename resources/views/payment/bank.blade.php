...
<style>
    ...
    .payment-method {
        ...
        border-left: 5px solidrgb(90, 119, 207);
        padding: 15px;
        border-radius: 5px;
        margin-bottom: 20px;
        font-size: 18px;
    ...
    .btn-invoice {
        ...
        width: 220px;
        margin: 30px auto 0;
        background-color:rgb(30, 233, 54);
        color: #fff;
        padding: 12px;
        border-radius: 6px;
        text-align: center;
...
<div class="payment-box">
    ...
    <div class="payment-method">
        Phương thức bạn chọn: Thanh toán ngân hàng
    </div>
    ...
    <div class="qr-box">
        ...
        <img src="https://homepage.momocdn.net/img/momo-upload-api-231208111806-638376310861365455.jpg" alt="QR ATM">
    </div>
    <div class="info-bank">
        <p>Số tài khoản quý tòa: 1026906112</p>
